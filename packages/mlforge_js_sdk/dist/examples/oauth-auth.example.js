 ...
 */
import { MLForge, AuthClient } from "../index.js";
// ============================================================================
...
async function nodeJsCustomConfig() {
    ...
    const forge = new MLForge({
        ...
        callbackTimeout: 60000, // 60 second timeout
...
export { nodeJsBasicLogin, nodeJsCustomConfig, nodeJsManualToken, directAuthClient, browserReactComponent, errorHandling, tokenLifecycleManagement, multiEnvironment, };
//# sourceMappingURL=oauth-auth.example.js.map